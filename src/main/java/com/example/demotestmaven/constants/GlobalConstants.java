package com.example.demotestmaven.constants;
...
public class GlobalConstants {
    ...
    public static final String INVALID_ROLECODE = "Invalid rolecode";
    public static final String INVALID_ROLETYPE = "Invalid roletype";
    ...
    public static final String USER_NOT_FOUND_BY_USERNAME_AND_EMAIL = "User not found by username and email: ";
    public static final String USER_NOT_FOUND_BY_USERNAME_AND_ID = "User not found by username and id: ";
    public static final String USER_NOT_FOUND_BY_EMAIL_AND_ID = "User not found by email and id: ";
    public static final String USER_NOT_FOUND_BY_USERNAME_AND_EMAIL_AND_ID = "User not found by username and email and id: ";

    // Get column header
    public static final String ROW_NUMBER_HEADER = "rownumber";
